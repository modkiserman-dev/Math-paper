...
\]
The second term in~\eqref{eq:perron-error} is already
$x^c/(T\log x)$. This gives~\eqref{eq:R-bound-raw}.
\end{proof}
...
For $x\geq2$, $|y|\leq\eta$, $T\geq1$, and
$c=1+1/\log x$, we have
...
\]
and $c=1+1/\log x$, the pole of $\zeta(s)$ at $s=1$ gives
\[
    \zeta(c)\ll\frac{1}{c-1}\ll\log x.
\]
